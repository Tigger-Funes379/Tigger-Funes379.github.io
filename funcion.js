...
document.getElementById('boton_mostrar4').addEventListener('click', function(){
    document.getElementById('texto4').style.display = 'block';
    document.getElementById('boton_mostrar4').style.display= 'none';
});
document.getElementById('boton_ocultar4').addEventListener('click', function(){
    document.getElementById('texto4').style.display = 'none';
    document.getElementById('boton_mostrar4').style.display= 'block';
});